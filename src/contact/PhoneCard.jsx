...
const PhoneCard = () => {
  return (
    ...
    style={{perspective:1200}}>
      ...
      <div className='relative w-52 h-90 rounded-2xl '
      style={{
        ...
        className='w-full h-full bg-white rounded-2xl ring-3  ring-white border-2 border-r-4 border-b-4 border-black flex flex-col items-center justify-around absolute left-[50%] -translate-x-[50%] z-50'>
        
        <div className='absolute top-3 bg-black rounded-xl w-[30%] h-2'>
        </div>

        <div className='absolute right-4 top-1 flex '>
          <svg
         xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          <path d="M3 15h2v5H3zm4-3h2v8H7zm4-3h2v11h-2zm4-3h2v14h-2z"></path>
        </svg>

        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24" >
          <path d="M20 8c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-2h2v-4h-2zM4 16V8h14v8z"></path><path d="M6 10h2v4H6zm4 0h2v4h-2z"></path>
        </svg>
        </div>
        ...
        <button className='bg-lime-600 text-white px-5 py-1 rounded-lg flex gap-2 hover:bg-lime-500 hover:text-neutral-200 transition-all duration-200 '>
           <svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24" >
