...
const Navbar = () => {
  ...
  return (
    ...
    className='relative overflow-hidden'>
      ...
      <motion.img src={assets.cartire} 
      alt="Car Tire"
      className="absolute top-0 left-0 w-10"
      initial={{x:-100,rotate:0,opacity:1}}
      animate={active ? {x:1600,rotate:720, opacity:1}:{}}
    ...
    className='w-full rounded-xl bg-neutral-700 text-sm capatalize flex items-center  justify-between px-2 py-1'>
      ...
      <div className='text-sm capitalize flex gap-3 text-neutral-50 items-center 
        ...
        className='bg-lime-600 text-white px-2 py-1 rounded-lg flex gap-2 hover:bg-lime-500 hover:text-neutral-700 transition-all duration-100 active:scale-95'>
